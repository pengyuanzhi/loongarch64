...
int constant_set_state_periodic(void)
{
    ...
    csr_write64(timer_config, LOONGARCH_CSR_CSR_TCFG);
 ...
 * @brief ARM定时器预初始化
 *
 * @details 注册LoongArch定时器操作函数到TTOS系统
 *
 * @return 成功返回0
 *
 * @retval 0 初始化成功
