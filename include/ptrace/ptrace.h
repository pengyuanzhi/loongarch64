...
/*************************** 宏定义 ****************************/
/**
 * @defgroup NT_Types 寄存器集合类型
 * @brief 用于 ptrace 的 NT_PRSTATUS 等请求
 * @{
 */
...
/*************************** ptrace 标志定义 ****************************/
/**
 * @defgroup PtraceFlags ptrace 标志位定义
 * @{
 */
...
/**
 * @defgroup PtraceMasks ptrace 掩码定义
 * @{
 */
 ...
 * @brief 进程控制块结构
 *
 * @details 包含进程的所有状态信息，包括异常上下文、程序入口和调试状态
 */
struct process_control_block
{
    /* 异常上下文（必须） */
    struct arch_context exception_context; /**< @brief 异常上下文 */
 ...
 * @brief 进程控制块指针类型
 *
 * @details 简化版本，实际项目中应使用真实的 PCB 结构
 */
